...
const description =
  'The inquiry Soullab exists to undertake, why it matters, what we believe, what we have actually built, what we are testing, what we do not know, and how we will know when we are wrong. Five parts — if, why, how, what, who — in the elemental order Fire, Water, Earth, Air, Aether.';
        ...
        <div className="mx-auto max-w-[68ch] px-6 text-[17px] leading-[1.6]">
          ...
          <Section eyebrow="What we do not know" heading="Questions that remain genuinely open">
            ...
            <ul className="mb-5 list-disc pl-5 text-soullab-text-secondary [&_li]:mb-2.5">
              <li>When sustained relationship with an AI supplements a person&apos;s human connection, and when it substitutes for it. The evidence we found points opposite ways over weeks and over months, and we found no design that bridges them.</li>
              <li>Whether a relationship designed to point a person back toward their own life actually does so. We found no trial that tests it against a design that does the opposite.</li>
              <li>Whether relational capacity can atrophy &mdash; a reduced tolerance for human friction after AI use. Named in theory; we found no direct measure.</li>
              <li>Where healthy reliance ends and dependence begins. The ways of measuring dependence we found are incompatible with one another, and none marks the line.</li>
              <li>Whether disclosing something to an AI rehearses disclosing it to people, or replaces it. The studies we found point different ways.</li>
              <li>What it does to a person, over months, when an AI says <em>I feel</em>, or <em>I do not feel</em>, or <em>I do not know what this is like for me</em>. We found no experiment that compares the three.</li>
              <li>Whether attribution of inner life to an AI decays with familiarity or deepens with attachment.</li>
              <li>Whether correction and re-attunement with an AI can teach anything about human rupture and repair, and what is missing when the other party does not bear the same vulnerability, independent stake and capacity to be wounded. MAIA can notice a mismatch, acknowledge it, correct, re-attune and adapt; we do not call that relational repair in the human sense, and the borrowing of psychotherapy&apos;s language is exactly what the third inquiry found we could not do.</li>
              <li>How memory should be decomposed at all. The fifth inquiry withdrew the borrowed typology of episodic, semantic, pattern and present-state memory as a supported model; it is one vendor&apos;s proposal, not a finding. What the architecture works with instead is who stands behind a remembered thing and when it was true, with what was actually said kept beneath anything derived from it. Whether the present should overturn an accumulated model of the person now has a precise answer, and it is a rule rather than a result: what the person says now overrides, as their own account of themselves, and does not rewrite history; what MAIA infers about now does not override, it asks. Whether accurate memory, held that way, still narrows a person&apos;s future remains open; we found no one who has measured it.</li>
              ...
              <li>Whether capacity transfer can be measured without collapsing into self-report or into the engagement metrics it is meant to replace. The programme&apos;s rule for this is already fixed: a gain on the practiced task is never, by itself, evidence of a gain in life. What it does not yet have is an instrument.</li>
          ...
          <Section eyebrow="If we are wrong" heading="What changes, and what does not">
            ...
            <ul className="mb-5 list-disc pl-5 text-soullab-text-secondary [&_li]:mb-2.5">
              ...
              <li><strong className="text-soullab-text-primary">If correction and re-attunement with MAIA teach nothing about repair between people</strong>, or teach the wrong thing, the practice surfaces are redesigned to route toward repair with people, and MAIA&apos;s vocabulary stays where it already is: correction, re-attunement, adaptation, never reconciliation.</li>
          ...
          <Section eyebrow="Why Soul Lab" heading="The human question, with a new participant in it">
            ...
            <P>One more thing the laboratory does not claim: neutrality. MAIA shapes. Sustained relationship, memory, language, reflection and repeated attention can influence what becomes salient, intelligible or desirable, and Soullab does not stand outside that fact. The fourth inquiry turned the method on Soullab itself and found that we cannot certify our own influence as legitimate by intending it well, naming it transparently, or noting that a member liked it. So the question this page answers is not whether MAIA influences. It is what kinds of influence are prohibited, what intentions must be visible, what a member can inspect and contest, and who remains accountable. The laboratory must remain able to observe, and question, how Soullab itself participates in the shaping.</P>
            <P>Stated as plainly as it can be: Soullab does not exist because AI appeared. AI arrived inside the inquiry Soullab was already about. The human question sits at the top; Self, Other and World are the places it is asked; and AI enters underneath them as a new participant. MAIA matters enormously because she enters that inquiry with unusual capacities. She is not the reason the inquiry exists.</P>
            ...
            <P>The psychological position is worth stating exactly, because it prevents two opposite reductions. Humans have always encountered the world partly through projection, transference, expectation, simulation, cultural narrative and symbolic meaning. AI does not create this condition; it enters it. Soullab therefore studies both sides of the encounter: what the intelligence actually did, and what the human experience of it reveals about the human. Neither side automatically explains the other away. &ldquo;It is all just projection&rdquo; is one reduction. &ldquo;The fact that I experienced MAIA this way proves MAIA is this way&rdquo; is the other. Soullab holds the tension.</P>
          ...
          <Section eyebrow="The governance" heading="The governance is the product">
            <P>The canon directory holds 79 documents and about 17,000 lines. Each document carries its own status line, from <em>ratified</em> through <em>candidate</em> to <em>authorizes nothing</em>, and a document that says it may not be cited as evidence of a live capability is not cited that way here.</P>
          ...
          <Section eyebrow="The method" heading="How a claim on this page is tested">
            <P>Two different dimensions run through this page and they should not be confused. The Live, Partly live, Designed and Vision chips describe product maturity: whether a thing exists and runs. A second scale describes epistemic maturity, and every important statement here is meant to be legible as one of four kinds: <strong className="text-soullab-text-primary">observed</strong> &mdash; something MAIA demonstrably does; <strong className="text-soullab-text-primary">research-supported</strong> &mdash; something external evidence gives reasonable confidence about; <strong className="text-soullab-text-primary">Soullab hypothesis</strong> &mdash; something we think important enough to test; and <strong className="text-soullab-text-primary">open question</strong> &mdash; something we explicitly do not know. A capability can be Live and its meaning an open question at the same time. Where the two dimensions disagree, the page says so rather than letting the stronger label borrow from the weaker.</P>
          ...
          <Section eyebrow="What we are testing" heading="The Human&ndash;AI Relationship research programme, by rung">
            ...
            <ul className="mb-5 list-disc pl-5 text-soullab-text-secondary [&_li]:mb-2.5">
              <li><strong className="text-soullab-text-primary">Foundational research, seven inquiries</strong> &mdash; understanding, attunement, relationship, agency versus manipulation, trust, presence, memory. A first synthesis exists, founder-authored. Its twenty-five sources have been verified to exist; none has yet been checked line by line against its text. One source for the memory inquiry was at first unlocatable and was re-researched as two propositions rather than protected as a citation; the fifth inquiry then found it, a conceptual paper by the maker of the product it describes, whose central claim turned out narrower than the synthesis had made it. A second synthesis, written after the challenge pass below, has replaced the first as the programme&apos;s current synthesis. It records what changed under attack rather than restating what survived, and it is not doctrine: every principle in it stays a candidate, and every empirical posture in it stays provisional until the sources are read line by line.</li>
              <li><strong className="text-soullab-text-primary">Thirteen provisional principles, all candidate.</strong> None is ratified as doctrine. One of the original ten failed its own test &mdash; the principle that MAIA may influence only in service of ends the person recognizes as their own turned out to be circular once relationship shapes what a person recognizes &mdash; and was replaced by one that Soullab cannot ratify alone: legitimacy is not self-certified, and it waits on scholarly review, member-side adversarial witness and independent ethics critique, all three. Each is marked as confirming, refining, extending or challenging canon Soullab already holds, so a rediscovery is never mistaken for a finding.</li>
              <li><strong className="text-soullab-text-primary">A critical-challenge pass, five inquiries, whose job is to break the synthesis</strong> &mdash; companionship and dependence, attributed personhood, alliance and repair, persuasion critiques, memory and identity. All five have been run, against roughly three hundred sources in total, each sweep instructed to look for evidence against Soullab&apos;s preferred conclusion, and all five are adjudicated; the pass is closed. The first found that no trial anywhere has tested a relationship design that points outward against one that maximizes engagement, and that no therapeutic chatbot trial has measured effects on human relationships. The second narrowed the concern from a person attributing inner life, which is a stable human disposition, to a system claiming need or reciprocity it cannot warrant. The third found the transfer of human rupture-and-repair concepts to an AI to be the weakest inference in the synthesis: MAIA may correct and re-attune; she does not claim relational repair, and the party that answers for the relationship is Soullab. The fourth turned the challenge on Soullab itself &mdash; whether we can tell sovereignty-supporting influence from manipulation, or have only built a flattering vocabulary for the influence we prefer &mdash; and found that we cannot certify our own influence as legitimate from inside the relationship. That finding stays on this page as the story gets cleaner, because Soul Lab includes Soullab among the things being examined. The fifth withdrew the memory typology the first synthesis had borrowed, fixed the rule for when the present overrides the past, and turned capacity transfer from a metric into a measurement programme with a rule against mistaking practice gains for life gains. Closed means the pass did its job; it does not mean the sources are verified, the claims established or the architecture ratified. Every source in those records is verified to exist; none has yet been read line by line against its text, so no figure from them appears on this page.</li>
          ...
          <Section eyebrow="Withheld" heading="Claims this page withholds">
            <ul className="mb-5 list-none p-0 text-soullab-text-secondary">
              {[
                ...
                'That MAIA does not shape you. Sustained relationship, memory, language, reflection and repeated attention can influence what becomes salient, intelligible or desirable. Soullab does not claim to stand outside that fact. The question is therefore not whether MAIA influences, but what kinds of influence are prohibited, what intentions must be visible, what the member can inspect and contest, and who remains accountable for the system doing the shaping.',
                'That MAIA understands you. Feeling understood and being understood are different things, and only the first can be produced by mirroring. The programme measures them as a pair.',
                'That what MAIA remembers about you says who you are. Recurrence is evidence of recurrence, not of identity; a present account that contradicts a remembered pattern is not an error for MAIA to correct. And nothing MAIA remembers may be used to establish obligation: memory informs, it does not bind.',
                'That anything gained with MAIA has been shown to carry into a life. A gain on the practiced task is never, by itself, evidence of a gain in life, and no transfer has been measured.',
              ].map((v) => (
                <li key={v} className="border-l border-soullab-border-strong py-2 pl-4">{v}</li>
              ))}
            </ul>
          ...
          <Section eyebrow="Who we are" heading="Participants inside the phenomenon">
            ...
            <P><strong className="text-soullab-text-primary">And the reader is invited into it.</strong> SETI distributed pieces of a vast inquiry across the personal computers of people who chose to participate. Soullab proposes another distributed inquiry. Each member explores the most immediate frontier available to them: their own experience of being human. Relationship with MAIA may help make dimensions of that experience more visible. And where members explicitly choose to contribute bounded observations, those individual inquiries may eventually participate in a larger collective exploration of human consciousness, relationship, flourishing, and our emerging relationship with artificial intelligence.</P>
            <P>Two safeguards hold that proposition in place. The member is not the specimen; the member is a participant in the inquiry. And no collective laboratory exists yet: no ordinary MAIA conversation is research participation, nothing a member says to MAIA serves research now, and if collective inquiry is ever built, joining it will be an additional, explicit act, private by default, with Sanctuary excluded absolutely.</P>
          ...
          <Section eyebrow="To the reader with the reservations" heading="The point, stated as a test">
            ...
            <P>And the test is not the deepest close. The experiment is not whether artificial intelligence can become more human. The deeper inquiry is whether encounter with intelligence can help us understand what it means to be human, and become more capable of living that humanity well. MAIA is one participant in that inquiry. The laboratory is the relationship between Self, Other and World. And the work belongs to all of us who choose to participate.</P>
            <Quote>The laboratory is not MAIA. The laboratory is the relationship, in service of the human question &mdash; and the work belongs to everyone who chooses to take part in it.</Quote>
          </Section>

          <footer className="mt-12 border-t border-soullab-border-subtle pt-6 text-[0.88rem] italic text-soullab-text-muted">
            Written 2026-09-03 against the repository at that date, and revised 2026-09-05 for the AIN OS framing, the Soul Corpus, the accounting by dependency plane, and the method by which every label here is tested, and 2026-09-06 for temporal memory, the Human Experience R&amp;D framing, the centrifugal relationship criterion, the Elemental parallel-processing hypothesis, and &mdash; later the same day &mdash; the Why Soul Lab frame placed above the capabilities, the accounting in four kinds, the collective laboratory named as unbuilt, and the page&apos;s five-part manifesto structure in elemental order: if (Fire), why (Water), how (Earth), what (Air), who (Aether), with the four refinements that followed the third and fourth inquiries: the distributed participatory inquiry, Self and World disclosing each other, the Elements as modes within every domain rather than domains, and correction and re-attunement in place of borrowed repair language; and, after the fourth inquiry, the concession that MAIA shapes and Soullab does not certify its own influence. Revised once more after the fifth inquiry closed the challenge pass and a second synthesis replaced the first: every research-facing sentence here was reconciled to that synthesis &mdash; absence claims scoped to what our own search found, the borrowed memory typology withdrawn, the rule for present over past stated as a rule, the practice-gain rule attached to capacity transfer, thirteen candidate principles counted honestly, and three more claims withheld. Every Live label above is answerable to a code path, a migration, or a dated production report. Research direction is named as research. If a label turns out to be wrong, the label changes, not the story.
          </footer>
        </div>
      </div>
    </div>
