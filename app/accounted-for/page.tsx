      ...
      <div className="mx-auto min-h-screen max-w-[1040px] border-x border-soullab-border-subtle bg-soullab-canvas pb-16">
        <div className="mx-auto max-w-[68ch] px-6 text-[17px] leading-[1.6]">
          ...
          <Section eyebrow="Reservation one" heading={<em className="text-soullab-text-secondary">&ldquo;The memory resets between interactions.&rdquo;</em>}>
            ...
            <Quote>The language model thinks with MAIA; it does not contain MAIA. Memory persists outside the model, so the model can change without the relationship disappearing with it.</Quote>
            ...
            <ul className="mb-5 list-disc pl-5 text-soullab-text-secondary [&_li]:mb-2.5">
              ...
              <li><Chip layer="vision" /> Any claim of a &ldquo;unified intelligence of a person&apos;s whole life.&rdquo; The layers above are real and they accumulate, but cross-layer synthesis is deliberately frozen.</li>
            </ul>
            ...
            <P>That trajectory is held to the same standard as memory. Four things are distinct and should not be read as one: that a capability exists somewhere in MAIA; that it participates in the ordinary sovereign conversational turn; that it participates through one unified cognition path; and that a person has actually lived a conversation in which it did. Cross-session continuity is live. Provenance is partly live, and named above wherever it is not. The elemental, relational, developmental and symbolic intelligences are existing capabilities whose participation in the ordinary turn is being censused rather than asserted here. Unified longitudinal cognition is trajectory, and not yet proven live.</P>
