        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-black/40 backdrop-blur-md border border-dune-bene-gesserit-gold/30 rounded-lg p-6 shadow-xl overflow-visible relative" style={{ zIndex: 10 }}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-4">
                ...
                <div className="flex-1 relative">
                  <label className="block text-xs text-white/70 mb-1">House System</label>
                  <select
                    value={houseSystem}
              ...
              <div className="mb-4">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-1 text-white/50 hover:text-white/70 text-[10px] transition-colors"
                >
                ...
                <AnimatePresence>
                  {showHouseGuide && (
                    ...
                    >
                      <div className="mt-3 p-3 bg-black/30 rounded-lg border border-dune-bene-gesserit-gold/20 text-[10px] text-white/70 space-y-2">
            ...
            <div className="bg-black/40 backdrop-blur-md border border-dune-bene-gesserit-gold/30 rounded-lg p-6 shadow-xl">
              ...
              <p className="text-white/70 text-xs mb-4 italic">Click a planet to reveal archetypal insights</p>
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          <span className={zodiacMode === 'sidereal' ? 'text-indigo-300' : 'text-dune-amber'}>
                            ...
                            <span className="text-white/70 ml-2">H{(data as PlanetPosition)?.house}</span>
                          </span>
                          {isExpanded ? (
                          ...
                          >
                            ...
                            >
                              ...
                              <div className="flex items-center gap-2 mb-3 flex-wrap">
                                ...
                                <span className="px-2 py-0.5 rounded-full text-xs bg-white/10 text-white/70 uppercase tracking-wide">
                              ...
                              <div className="space-y-3">
                                {/* Planetary Archetype */}
                                <div>
                                  <h5 className="text-xs uppercase tracking-wider text-white/70 mb-1">
                                    {name} Archetype
                                  </h5>
                                      ...
                                      {planetAspects.slice(0, 3).map((aspect, idx) => {
                                        ...
                                        return (
                                          <div key={idx} className="text-xs">
                                            ...
                                            <span className="text-white/70"> with {otherPlanet}</span>
                                            {aspectSynthesis?.coreQuestion && (
                                              <p className="text-white/70 text-xs italic mt-0.5 pl-2 border-l border-white/10">
                                                {aspectSynthesis.coreQuestion}
                                              </p>
                                            )}
                                          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-black/30 border border-dune-fremen-azure/30 rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs text-white/70">Approaching</span>
                </div>
                <p className="text-white/80 text-sm">
              ...
              <div className="mt-6 rounded-2xl border border-white/10 bg-black/20 p-5 shadow-lg">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="text-sm text-white/70">Your recent relationship analyses</p>
                  </div>
                  <div className="flex items-center gap-2">
                    <Link
                      href="/astrology/synastry"
                ...
                <div className="mt-4 grid gap-3 md:grid-cols-3">
                  {savedSynastryLoading ? (
                    ...
                    <div className="col-span-3 text-sm text-white/70 py-4">
