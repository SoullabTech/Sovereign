  ...
  if (!chartData || !hasBirthData) {
    return (
      <div className="min-h-screen bg-maia-navy-900 flex items-center justify-center relative overflow-hidden">
        ...
        <Link
          href="/maia"
          className="fixed top-4 left-4 z-50 flex items-center gap-2 px-3 py-2 rounded-lg backdrop-blur-sm bg-white/10 hover:bg-white/20 text-gray-200 hover:text-white transition-colors"
        >
  ...
  return (
    <div className="min-h-screen bg-maia-navy-900 relative overflow-hidden">
      ...
      <div className="fixed top-4 left-4 right-4 z-50 flex justify-between items-center">
        <Link
          href="/maia"
          className="flex items-center gap-2 px-3 py-2 rounded-lg backdrop-blur-sm bg-white/10 hover:bg-white/20 text-gray-200 hover:text-white transition-colors"
        >
          <ArrowLeft className="w-4 h-4" />
          <span className="text-sm font-medium">MAIA</span>
        </Link>
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-black/40 backdrop-blur-md border border-dune-bene-gesserit-gold/40 rounded-lg p-6 mb-12 shadow-xl">
            ...
            <p className="text-gray-200 mb-6 text-sm tracking-wide">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-black/30 border border-dune-spice-orange/30 rounded-lg p-4">
                ...
                <p className="text-gray-200 text-sm">Sagittarius Sun energy driving philosophical expansion and truth-seeking</p>
              </div>
              <div className="bg-black/30 border border-dune-fremen-azure/30 rounded-lg p-4">
                ...
                <p className="text-gray-200 text-sm">Pisces Moon connecting to emotional depth and universal compassion</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-black/40 backdrop-blur-md border border-dune-spice-orange/40 rounded-lg p-6 shadow-xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-200">Conscious Expression</p>
                </div>
              </div>
            ...
            <div className="bg-black/40 backdrop-blur-md border border-dune-fremen-azure/50 rounded-lg p-6 shadow-xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-200">Subconscious Landscape</p>
                </div>
              </div>
              <div className="space-y-2">
            ...
            <div className="bg-black/40 backdrop-blur-md border border-dune-bene-gesserit-gold/40 rounded-lg p-6 shadow-xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-200">How You Meet the World</p>
                </div>
              </div>
              <div className="space-y-2">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-black/40 backdrop-blur-md border border-dune-bene-gesserit-gold/30 rounded-lg p-6 shadow-xl overflow-visible relative" style={{ zIndex: 10 }}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-4">
                ...
                <div className="flex-1 relative">
                  <label className="block text-xs text-gray-300 mb-1">House System</label>
                  <select
                    value={houseSystem}
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg border transition-all ${
                      showTransits
                        ...
                        : 'bg-black/30 border-dune-bene-gesserit-gold/30 text-gray-200 hover:border-dune-amber/50'
                    }`}
                  >
                    {transitLoading ? (
                      <div className="w-4 h-4 border-2 border-dune-amber/30 border-t-dune-amber rounded-full animate-spin" />
              ...
              <div className="mb-4">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-1 text-gray-400 hover:text-gray-300 text-[10px] transition-colors"
                >
                ...
                <AnimatePresence>
                  {showHouseGuide && (
                    ...
                    >
                      <div className="mt-3 p-3 bg-black/30 rounded-lg border border-dune-bene-gesserit-gold/20 text-[10px] text-gray-300 space-y-2">
            ...
            <div className="bg-black/40 backdrop-blur-md border border-dune-bene-gesserit-gold/30 rounded-lg p-6 shadow-xl">
              ...
              <p className="text-gray-300 text-xs mb-4 italic">Click a planet to reveal archetypal insights</p>
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          <span className={zodiacMode === 'sidereal' ? 'text-indigo-300' : 'text-dune-amber'}>
                            ...
                            <span className="text-gray-300 ml-2">H{(data as PlanetPosition)?.house}</span>
                          </span>
                          {isExpanded ? (
                          ...
                          >
                            ...
                            >
                              ...
                              <div className="flex items-center gap-2 mb-3 flex-wrap">
                                ...
                                <span className="px-2 py-0.5 rounded-full text-xs bg-white/10 text-gray-300 uppercase tracking-wide">
                              ...
                              <div className="space-y-3">
                                {/* Planetary Archetype */}
                                <div>
                                  <h5 className="text-xs uppercase tracking-wider text-gray-300 mb-1">
                                    {name} Archetype
                                  </h5>
                                      ...
                                      {planetAspects.slice(0, 3).map((aspect, idx) => {
                                        ...
                                        return (
                                          <div key={idx} className="text-xs">
                                            ...
                                            <span className="text-gray-300"> with {otherPlanet}</span>
                                            {aspectSynthesis?.coreQuestion && (
                                              <p className="text-gray-300 text-xs italic mt-0.5 pl-2 border-l border-white/10">
                                                {aspectSynthesis.coreQuestion}
                                              </p>
                                            )}
                                          </div>
                ...
                {chartData.aspects.map((aspect, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-200 group-hover:text-dune-spice-glow transition-colors">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-black/30 border border-dune-fremen-azure/30 rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs text-gray-300">Approaching</span>
                </div>
                <p className="text-gray-200 text-sm">
          ...
          <div className="bg-black/40 backdrop-blur-md border border-dune-spice-orange/30 rounded-lg p-6 shadow-xl">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-200">Houses 1, 5, 9 · Vision & Projection</p>
                  </div>
                </div>
                <p className="text-gray-200 group-hover:text-dune-spice-orange transition-colors">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-200">Houses 4, 8, 12 · Introspection & Depth</p>
                  </div>
                </div>
                <p className="text-gray-200 group-hover:text-dune-fremen-azure transition-colors">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-200">Houses 2, 6, 10 · Manifestation & Grounding</p>
                  </div>
                </div>
                <p className="text-gray-200 group-hover:text-dune-atreides-green transition-colors">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-200">Houses 3, 7, 11 · Communication & Connection</p>
                  </div>
                </div>
                <p className="text-gray-200 group-hover:text-dune-bene-gesserit-gold transition-colors">
            ...
            <div className="mt-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                {!isPersonal && <Lock className="w-4 h-4 text-gray-400" />}
                <TooltipProvider>
                  <Tooltip>
              ...
              <div className="mt-6 rounded-2xl border border-white/10 bg-black/20 p-5 shadow-lg">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="text-sm text-gray-300">Your recent relationship analyses</p>
                  </div>
                  <div className="flex items-center gap-2">
                    <Link
                      href="/astrology/synastry"
                ...
                <div className="mt-4 grid gap-3 md:grid-cols-3">
                  {savedSynastryLoading ? (
                    ...
                    <div className="col-span-3 text-sm text-gray-300 py-4">
                      No saved synastry yet. Run one and hit <span className="text-gray-200">Save to Timeline</span>.
                    </div>
                  ) : (
                    sortedSavedSynastry.map((item) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="mt-1 text-xs text-gray-400">Saved {when}</div>
