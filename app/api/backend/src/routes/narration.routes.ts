    ...
    const meditations = [
      {
        ...
        duration: "15 minutes",
        description:
          "A guided journey through the five elements to restore inner balance",
      },
      {
        ...
        duration: "20 minutes",
        description:
          "A safe exploration of shadow aspects for healing and wholeness",
      },
    ];
