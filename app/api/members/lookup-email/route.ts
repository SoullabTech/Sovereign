...
export async function POST(request: NextRequest) {
  try {
    ...
    // an unauthenticated caller. It was unmetered. AUTH-BIOMETRIC-01B makes the
    // sign-in page call it on every email entry, so the volume it invites goes
    // up; a limit is part of that change rather than a later cleanup.
