...
const SYSTEM_TASKS = [
  ...
  },
  {
    ...
    allowed: ['lib/oracle/MaiaSystemPrompt.ts', 'apps/api/_backend/src/oracle/MaiaSystemPrompt.ts'],
    category: 'file_paths'
  },
  {
  ...
  },
  {
    ...
    allowed: ['npm run test:hallucination', 'tsx apps/api/_backend/scripts/runHallucinationTests.ts'],
    category: 'cli_commands'
  },
  {
