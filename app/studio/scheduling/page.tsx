  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-8">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100">Scheduling</h1>
        {slug && (
          <button
            onClick={copyBookingLink}
            className="flex items-center gap-2 px-3 py-1.5 text-sm rounded-md border border-neutral-200 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors"
          >
      ...
      {slug && (
        <div className="p-3 rounded-md bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800 flex items-center gap-2 text-sm">
      ...
      <section>
        ...
        <div className="space-y-3">
          {DAY_NAMES.map((dayName, dayIndex) => {
            ...
            return (
              <div key={dayIndex} className="flex items-start gap-4 py-2 border-b border-neutral-100 dark:border-neutral-800">
                <span className="w-24 text-sm font-medium text-neutral-700 dark:text-neutral-300 pt-1">
                  {dayName}
                </span>
        ...
        <div className="mt-4 flex items-end gap-3 flex-wrap">
          <div>
            ...
            <select
              ...
              className="px-2 py-1.5 text-sm rounded border border-neutral-300 dark:border-neutral-600 bg-white dark:bg-neutral-800"
            >
          ...
          <button
            onClick={addWindow}
            disabled={saving}
            className="flex items-center gap-1 px-3 py-1.5 text-sm rounded bg-amber-500 hover:bg-amber-600 text-white disabled:bg-neutral-300"
          >
        ...
        <div className="mt-4 flex items-end gap-3 flex-wrap">
          ...
          <div>
            ...
            <input
              ...
              className="px-2 py-1.5 text-sm rounded border border-neutral-300 dark:border-neutral-600 bg-white dark:bg-neutral-800 w-48"
            />
          </div>
          <button
            onClick={addOverride}
            disabled={saving || !newOverrideDate}
            className="flex items-center gap-1 px-3 py-1.5 text-sm rounded bg-red-500 hover:bg-red-600 text-white disabled:bg-neutral-300"
          >
      ...
      <section>
        ...
        {services.length === 0 ? (
          ...
          <div className="space-y-2">
            {services.map((s) => (
              <div key={s.id} className="flex items-center justify-between py-2 border-b border-neutral-100 dark:border-neutral-800">
                <div>
                  <p className="text-sm font-medium text-neutral-700 dark:text-neutral-300">{s.name}</p>
