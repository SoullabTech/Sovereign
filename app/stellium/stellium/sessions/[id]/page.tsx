      ...
      <div className="space-y-6">
        ...
        <Card className="bg-red-900/20 border-red-500/30">
          <CardContent className="p-6 text-center">
            ...
            <button
              onClick={() => router.push('/stellium/stellium/sessions')}
        ...
        <Card className="bg-gray-900/50 backdrop-blur-xl border-gray-700/20">
          <CardContent className="p-6">
            <div className="flex items-start justify-between">
              ...
              <button
                onClick={() => router.push(`/stellium/stellium/sessions/${sessionId}/edit`)}
        ...
        >
          ...
          {client && (
            <Card
              ...
              onClick={() => router.push(`/stellium/stellium/clients/${client.id}`)}
            >
