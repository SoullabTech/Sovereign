      ...
      <div className="space-y-6">
        ...
        <Card className="bg-red-900/20 border-red-500/30">
          <CardContent className="p-6 text-center">
            ...
            <button
              onClick={() => router.push('/stellium/stellium/clients')}
        ...
        <Card className="bg-gray-900/50 backdrop-blur-xl border-gray-700/20">
          <CardContent className="p-6">
            <div className="flex items-start justify-between">
              ...
              <button
                onClick={() => router.push(`/stellium/stellium/clients/${clientId}/edit`)}
            ...
            <CardContent>
              {sessions.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <button
                    onClick={() => router.push(`/stellium/stellium/sessions/new?clientId=${clientId}`)}
                ...
                <div className="space-y-4">
                  {sessions.map((session, index) => (
                    <motion.div
                      ...
                      onClick={() => router.push(`/stellium/stellium/sessions/${session.id}`)}
