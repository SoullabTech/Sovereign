                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-blue-50 rounded-lg p-3">
                    ...
                    <div className="text-sm text-blue-700 space-y-1">
                      <div>Awareness Level: {result.consciousnessState.awarenessLevel.level}/5 ({Math.round(result.consciousnessState.awarenessLevel.confidence * 100)}% confidence)</div>
