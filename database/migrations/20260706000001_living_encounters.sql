...
CREATE TABLE IF NOT EXISTS living_encounters (
...
CREATE TABLE IF NOT EXISTS living_encounter_events (
...
CREATE INDEX IF NOT EXISTS idx_lee_encounter ON living_encounter_events(encounter_id, id);
CREATE INDEX IF NOT EXISTS idx_lee_member_time ON living_encounter_events(member_id, created_at);
CREATE INDEX IF NOT EXISTS idx_le_member_field ON living_encounters(member_id, field_key, opened_at DESC);
