...
export const ACCESS_RULES: AccessRule[] = [
  ...
  // Larry — a gift portrait Kelly offers to Larry Clos (Kelly-approved 2026-06-26):
  ...
  { exact: '/soul-portrait/larry', public: true, notes: "Larry Clos Gift Portrait (renderer) — hand-delivered unlisted exception (founder→positive-psych coach); Mentor off; noindex" },
