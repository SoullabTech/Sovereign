 ...
 * PRODUCTION in its remote view. Every Desktop witness since DESKTOP-SHELL-01
 ...
 *
 * The House is now an overlay inside canonical `/maia`, not a route of its own,
 * and the local Electron renderer is witness scaffolding, not the product.
 * There is one visible MAIA and it is the canonical one.
 */
