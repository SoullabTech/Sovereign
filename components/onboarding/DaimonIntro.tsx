    ...
    <div className="min-h-screen bg-gradient-to-br from-[#E0F7FA] via-[#B2EBF2] to-[#80DEEA] flex items-center justify-center px-4 relative">
      ...
      <div className="relative z-10 w-full max-w-2xl mx-auto">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="mt-8 mx-auto block px-8 py-3 bg-gradient-to-r from-[#A7D8D1] via-[#80CBC4] to-[#4DB6AC] hover:from-[#8ECBC4] hover:via-[#6BB6AC] hover:to-[#4DB6AC] text-white rounded-xl font-medium transition-all flex items-center justify-center gap-2"
          style={{
