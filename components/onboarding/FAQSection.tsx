...
Use the feedback option in the app, or reach out directly to support@soullab.ai.
                ...
                <summary className="cursor-pointer list-none">
                  <div className="flex items-start gap-3 p-3 bg-black/20 border border-amber-500/20 rounded-lg hover:border-amber-500/40 transition-colors">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-2 text-xs text-amber-200/60 leading-relaxed group-open:block hidden">
                        Use the feedback option in the app, or reach out directly to support@soullab.ai. We read everything. Your experience — what works, what doesn't, what surprises you — is how MAIA gets better.
                      </div>
                    </div>
                  </div>
                </summary>
