...
export default function EmptyRelationalField({ onAddPerson, onAddInner, onStartFromMind }: EmptyRelationalFieldProps) {
  return (
    <div className="max-w-xl mx-auto py-20 text-center">
      <h2 className="text-2xl font-extralight text-stone-200 tracking-wide mb-4">
      ...
      <div className="space-y-4 mb-16">
        <button
          ...
          className="w-full max-w-sm mx-auto block px-6 py-4 rounded-lg border border-stone-700/40 bg-stone-900/25 hover:bg-stone-900/35 transition-colors text-left"
        >
          <div className="text-stone-200 font-light mb-1">Start with what is on your mind</div>
          <div className="text-xs text-stone-400">Something is present. Name it, and the field will form around it.</div>
        </button>
        ...
        <button
          ...
          className="w-full max-w-sm mx-auto block px-6 py-4 rounded-lg border border-stone-700/30 bg-stone-900/20 hover:bg-stone-900/30 transition-colors text-left"
        >
          <div className="text-stone-200 font-light mb-1">Meet an inner figure</div>
          <div className="text-xs text-stone-400">An archetype, inner part, or voice within. Name what you are in relation to.</div>
        </button>
        ...
        {/* Deliberately NOT an affordance — there is nothing here to press. It
            ...
            than offered. */}
        <p className="max-w-sm mx-auto text-xs text-stone-400/70 font-light leading-relaxed pt-2">
          Or simply talk with MAIA. Relational threads surface on their own — you
          don&apos;t have to set anything up first.
        </p>
      </div>

      <div className="w-16 h-px bg-gradient-to-r from-transparent via-amber-800/30 to-transparent mx-auto mb-6" />
      <p className="text-xs text-stone-400/60 font-light italic max-w-xs mx-auto">
