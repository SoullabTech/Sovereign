    ...
    >
      ...
      <div className="flex items-center gap-1">
        <div className="mr-2 flex items-center gap-2">
          ...
          {/* On narrow screens the mark stands alone — the wordmark text is
              redundant (the whole surface is MAIA) and its width overflowed the
              top bar at 375px. MAIA yields the corner, and on mobile it yields
              the wordmark too. */}
          <span className="hidden sm:inline text-sm font-light text-[#D4B896]/80 tracking-wider">MAIA</span>
        </div>
        {/* Voice / Text toggle */}
        <button
