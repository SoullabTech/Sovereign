...
import { MAIA_WORLDS, STUDIO_RAIL_ITEM, CIRCLES_RAIL_ITEM, LABTOOLS_RAIL_ITEM, MAIA_UTILITIES } from '@/lib/navigation/maiaNav';
...
export function MaiaLeftRail({ activeWorld, calmMode, calmCeiling, worldHints, onWorldChange, onOpenAccount }: MaiaLeftRailProps) {
  ...
  const handleItemClick = (id: MaiaRailItemId, route: string) => {
    if (id === 'studio' || id === 'circles' || id === 'labtools') {
      router.push(route);
    } else {
