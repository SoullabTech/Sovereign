...
export function buildNativePrompt(packet, repo) {
  ...
  return [
    ...
    "   Closed shape: [{\"path\":\"<allowed path>\",\"old_text\":\"<exact existing text>\",\"new_text\":\"<replacement text>\"}, ...]",
    "   The JSON value after EDIT_JSON: is the edit ARRAY ITSELF. Do not wrap it in an object and do not emit an edits key.",
    "   Put ALL required edit objects in that one array. Never repeat path, old_text, or new_text inside an edit object.",
    "   TWO-EDIT SYNTAX EXAMPLE ONLY: EDIT_JSON: [{\"path\":\"fileA\",\"old_text\":\"old1\",\"new_text\":\"new1\"},{\"path\":\"fileA\",\"old_text\":\"old2\",\"new_text\":\"new2\"}]",
    "   Notice there is ONE opening [ and ONE closing ]; multiple edit objects are comma-separated INSIDE that single array.",
