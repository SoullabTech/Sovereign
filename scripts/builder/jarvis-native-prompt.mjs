...
export function buildNativePrompt(packet, repo) {
  ...
  return [
    ...
    "   Do not wrap the diff in a Markdown code fence. Ordinary source characters, including single backticks, are allowed when they belong to the file.",
    "   Stop immediately after the final diff line; no commentary or summary may follow it.",
