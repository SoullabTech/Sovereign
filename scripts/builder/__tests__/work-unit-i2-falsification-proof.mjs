...
const QWEN={model_identity_id:'mi-q',route_participant_id:'primary',transport_binding_id:'tb-q',model_family:'QWEN',provider_id:'qwen-local',model_id:'qwen3-coder:30b',adapter_id:'opencode',role:'code_primary'};
