...
console.log('\n==================== F3 — dual provenance, never collapsed ====================');
{
  ...
  report('build stamp is a package-time artifact, not source', readFileSync(path.join(repoRoot, 'jarvis-desktop/.gitignore'), 'utf8').includes('build-info.json'));
...
console.log('\n==================== exclusions the ruling required ====================');
{
  ...
  report('preload exposes exactly four channels',
