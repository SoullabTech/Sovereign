...
SELECT expect_refusal($$INSERT INTO manuscript_revision_proposals (manuscript_id,draft_id,section_id,member_id,thread_id,produced_in_turn_index,proposed_text,reason,based_on,read_state,coverage,origin,authority,producer,input_fingerprint) VALUES ('22222222-2222-2222-2222-222222222222','33333333-3333-3333-3333-333333333333','44444444-4444-4444-4444-444444444444','11111111-1111-1111-1111-111111111111','aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa',0,'t','r','{}','{}','{}','work','{}','p','f')$$, 'T15 producer is an AUTHOR turn');

SELECT expect_refusal($$INSERT INTO manuscript_revision_proposals (manuscript_id,draft_id,section_id,member_id,proposed_text,reason,based_on,read_state,coverage,origin,authority,producer,input_fingerprint) VALUES ('22222222-2222-2222-2222-222222222222','33333333-3333-3333-3333-333333333333','44444444-4444-4444-4444-444444444444','11111111-1111-1111-1111-111111111111','t','r','{}','{}','{}','work','{}','p','f')$$, 'T16 born with NULL/NULL producer');

INSERT INTO manuscript_revision_proposals (manuscript_id,draft_id,section_id,member_id,thread_id,produced_in_turn_index,proposed_text,reason,based_on,read_state,coverage,origin,authority,producer,input_fingerprint)
