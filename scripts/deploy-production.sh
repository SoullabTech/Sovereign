...
run_migrations_or_abort() {
    ...
    log_error ""
    log_error "⚠️  A failing runner may have applied an earlier prefix of the pending set."
    log_error "   Do not infer the schema is unchanged. Inspect what applied before retry:"
    log_error ""
