# SOULLAB — Executive Brief for Mark Effinger
### Business Development / Advisory Engagement · Prepared 2026-07-12 · v2

**Status**: DRAFT pending Kelly's red-line. Derived from canonical sources (founder profile, system census 2026-07-11, ratified roadmap). Stamps: **LIVE** (running, receipt available) · **DESIGNED** (built/specced, deliberately withheld) · **VISION** (named horizon). `[KELLY SUPPLIES]` marks facts only the founder provides.
**Design**: Page One is complete in itself (3-minute read). Everything after it is optional depth. Stop whenever you've seen enough.
...
## What this is
A sovereignty-first relational intelligence platform designed to support human development without replacing human authorship. Soullab is not attempting to replace therapy, coaching, or meaning-making — **it is building the conditions under which those processes can remain human in the age of AI.**

## Why now
Intelligence is commoditizing. As AI capability becomes abundant, differentiation shifts toward trust, governance, continuity, sovereignty, and relationship quality — and public concern is growing around AI dependency, synthetic relationships, and erosion of human agency. Most platforms are retrofitting these concerns. **Soullab was architected around them from inception, and the governance itself is part of the product.**

## Why us
> **This is a 42-year lineage, not an AI pivot.** The architecture, governance, and founder history already exist today and are independently verifiable: a published framework and book, four decades of practice, and a constitution whose earliest vow appears in print (© 2024) before the platform matured.

## What exists today (LIVE, audit-witnessed)
Production relational intelligence (MAIA: three modes, three tiers, self-hosted) · consent-gated memory with SQL-level enforcement, proven by refusal tests · Sanctuary Mode (sessions that leave no memory) · full member arc (journaling voice/typed/upload, request-only AI reading, versioned Living Field) · practitioner Studio with two live reference fields · community layer · a registered publishing imprint with a flagship title in market.

## What we're asking of you
1. **Build the practitioner pipeline** (Founding Studio Program is the vehicle; two proof stories in hand).
...
## 4. Platform inventory (the maturity discipline itself)
...
1. **Ratification never leaves the founder.** Propose freely; nothing is standing until Kelly signs it.
2. **Every outward claim carries its stamp** (Live/Designed/Vision). The claim card makes this mechanical.
3. **The Failure Test**: if a reader asks to see X, X exists — applied to every sentence that leaves the building, including this brief.
4. **Demo protocol before any external showing.** One test: could this moment be screenshotted without violating anyone's consent?
5. **Found-and-closed is curriculum; found-and-open is need-to-know.** Radically transparent about what's proven and fixed; disciplined about what's in flight.

## 8. Working vocabulary (three terms, then you're fluent)

- **Sovereignty** — the member's ownership of their data, meaning, and decision-making authority; enforced in schema, not policy.
- **Authorship** — the person's standing as the final source of meaning and direction in their own development.
- **Relational intelligence** — AI designed to support human development without replacing human agency.
...
### The kit behind this brief
Claim card ("What We Say") · Demo protocol · Governance one-pager · Ordered reading path · Case Study Library (stamped) · Founding Studio Program brief · Founder profile (full lineage document) · *Elemental Alchemy* (your copy arrives with the welcome package).
