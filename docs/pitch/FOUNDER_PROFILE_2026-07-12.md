# FOUNDER PROFILE — Kelly Nezat (canonical source, 2026-07-12)

**Status**: DRAFT pending Kelly's red-line. Once signed, this is the **single source** all outward bios derive from (LinkedIn, Author Central, dossiers, Mark's deck Movement I, Press materials) — surfaces adapt register per the calibration rules below, never facts.
**Facts verified in Kelly's own words, 2026-07-11/12.** Note: uses "Multi-Archetypal Intelligence Architecture" — ratification A pending; if the ruling differs, this file updates first.

---

## Founder Overview

Kelly Nezat is the founder of Soullab and architect of MAIA (Multi-Archetypal Intelligence Architecture), a sovereignty-first relational intelligence platform exploring how technology can participate in human development while preserving human meaning, authorship, and soul.
...
At heart, Kelly considers himself a **shamanic alchemist** — a practitioner devoted to understanding how psyche, body, spirit, nature, and consciousness participate in the lifelong process of human becoming.

This inquiry gave rise to three interconnected bodies of work:

- **Spiralogic™** — an elemental framework for lifelong human development, refined over more than 34 years of practice and articulated in *Elemental Alchemy: The Art of Living a Phenomenal Life*.
