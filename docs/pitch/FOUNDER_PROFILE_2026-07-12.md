...
- **Spiralogic™** — an elemental framework for lifelong human development, refined over more than 34 years of practice.
- ***Elemental Alchemy: The Art of Living a Phenomenal Life*** — the framework's full articulation; a published, independently-hosted proof point of the arc.
...
From this purpose, in order, emerged: Jungian psychology (language for psyche and symbol) → shamanic practice (direct encounter with mystery) → healing work (accompanying transformation) → Spiralogic (mapping human becoming) → *Elemental Alchemy* (articulating the journey) → Soullab (community and practice) → **MAIA (asking whether technology can participate in this revelation without eclipsing it)**.
