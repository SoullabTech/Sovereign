# AIN-SYSTEMS-INTELLIGENCE-01 / S1 — Claim Ledger
...
## CL-01
**Claim:** "System" was constituted as a cross-disciplinary first-class object of inquiry by general systems theory, on the programmatic premise that general principles hold across kinds of system.
...
## CL-04
**Claim:** Second-order cybernetics distinguishes the cybernetics of observed systems from the cybernetics of observing systems, placing the observer inside the description and making the observer responsible for it.
- Class: ESTABLISHED_SOURCE
- Support: S05, S06
...
- Class: ESTABLISHED_SOURCE
- Support: S07 ("Conscious Purpose versus Nature")
- Limit: an argument, not an empirical result; S0 §VII does not derive its authority from it.

## CL-07
**Claim:** Attractor and bifurcation have precise mathematical definitions requiring a state space and a rule of evolution (or adequate time series).
- Class: ESTABLISHED_SOURCE
- Support: S09
- Limit: gives no procedure for identifying state variables in text, organizations or lives.

## CL-08
**Claim:** "Self-organization" names at least four distinct mechanisms in the lineage (dissipative structures, order-parameter pattern formation, network self-organization, self-organized criticality) plus one definitional sense (autopoietic self-production), and these are not the same phenomenon.
- Class: ESTABLISHED_SOURCE
- Support: S10, S12, S13, S16, S19
- Limit: the count is S1's reading; the sources themselves do not enumerate each other.

## CL-09
**Claim:** Haken's slaving principle gives a regime-specific formal account of a whole-level variable (order parameter) that constrains the components generating it (circular causality).
- Class: ESTABLISHED_SOURCE
- Support: S12
- Limit: near-instability regimes; not a general law of organization.

## CL-10
**Claim:** Simon's near-decomposability gives a measurable criterion for the reality of levels: within-subsystem interactions much stronger than between-subsystem interactions.
- Class: ESTABLISHED_SOURCE
- Support: S17
- Limit: must be measured on the system in question; assumed levels are not established levels.

## CL-11
**Claim:** Complexity science acknowledges that "complexity" has no agreed definition or measure.
- Class: ESTABLISHED_SOURCE
- Support: S18

## CL-12
**Claim:** Autopoiesis defines a living system by an organization that produces its own components and boundary, so that the boundary is produced by the system rather than drawn by an observer.
- Class: ESTABLISHED_SOURCE
- Support: S19, S20
- Limit: a definitional theory with debated empirical content.

## CL-13
**Claim:** Luhmann transposed autopoiesis to social systems as closed systems of communication with persons as environment, and whether that transposition is valid is a live disagreement.
- Class: ESTABLISHED_SOURCE
- Support: S21, S22

## CL-14
**Claim:** Rosen defined an anticipatory system as one containing a model of itself and/or its environment and acting on that model's predictions, and argued that organisms are complex in the sense of having no largest model; the formal machinery of the latter is contested.
- Class: ESTABLISHED_SOURCE (definitions) / SPECULATIVE_CORRESPONDENCE (as a formal account of life)
- Support: S23, S24
- Limit: ⛔ not to be cited as established.

## CL-15
**Claim:** Ecological resilience is distinguished from stability and admits multiple stable states; transformation across nested scales has a heuristic cyclic schema (the adaptive cycle).
- Class: ESTABLISHED_SOURCE (resilience) / ENGINEERING_ANALOGY (adaptive cycle as a schema)
- Support: S25, S26
- Limit: the adaptive cycle is descriptive; its four-phase structure establishes no correspondence to any other four-phase model.

## CL-16
**Claim:** Generic early-warning signals (critical slowing down, rising variance and autocorrelation) may precede critical transitions across system classes; methods exist and have been validated on simulated series with known transitions.
- Class: ESTABLISHED_SOURCE
- Support: S27, S28

## CL-17
**Claim:** Proposed early-warning indicators rarely characterize their error rates, and a detection without characterized false-alarm and missed-warning rates is not reliable evidence.
- Class: ESTABLISHED_SOURCE
- Support: S29

## CL-18
**Claim:** System dynamics supplies operational meanings of stock, flow, delay and feedback loop, within a frame whose stated purpose is modelling for intervention.
- Class: ESTABLISHED_SOURCE
- Support: S30, S31, S32, S34
...
## CL-21
**Claim:** Management cybernetics provides a recursive regulator architecture for organizations (the Viable System Model).
- Class: ESTABLISHED_SOURCE
- Support: S39
- Limit: an organizational instrument; nothing in the source addresses persons as subjects.
...
## CL-23
**Claim:** Enactivism holds that cognition is embodied action arising from an autonomous system's coupling with its environment, and that organization alone does not yield sense-making; adaptivity (self-regulation with respect to viability) is required.
- Class: ESTABLISHED_SOURCE
- Support: S41, S42, S43
- Limit: philosophical; empirical commitments are programmatic.

## CL-24
**Claim:** Emergence has a benchmark-usable weak definition (derivable only by simulation), a distinct strong definition (not deducible in principle), and a standing objection to any causal reading (causal exclusion).
- Class: ESTABLISHED_SOURCE
- Support: S44, S45, S46, S47
