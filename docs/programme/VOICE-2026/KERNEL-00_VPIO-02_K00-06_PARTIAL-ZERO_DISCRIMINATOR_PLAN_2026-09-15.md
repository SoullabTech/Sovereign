...
The DAS-log observer did not attach and therefore never opened CLEAR-02/PRELIGHT-03/BATCH-03. Independent device-state evidence later showed total harness 0. The observer process was retired before any Voice authority spend. Direct successor wrapper `6ba680b7…` requires Mac output custody and total harness 0 at invocation, then PRELIGHT-03 CLEAN and the unchanged one-shot fresh full N=10 BATCH-03. It cannot invoke CLEAR-02, `idevicesyslog`, or any process termination. Gate **97/97**.
