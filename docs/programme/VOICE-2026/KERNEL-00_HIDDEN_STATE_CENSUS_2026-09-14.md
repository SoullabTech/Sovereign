...
Both probe directories (`021452Z` invalid, `121147Z` valid) are to be committed beside each other as the record of C-D11. Gate 35/35. **The single calibration line is authorized on this tip.**
