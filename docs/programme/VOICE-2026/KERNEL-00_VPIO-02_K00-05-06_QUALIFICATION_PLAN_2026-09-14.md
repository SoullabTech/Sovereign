...
No final source class is earned. PRELIGHT-02 CLEAN; five completed rows are VALID but all five population rows are CHARACTERIZE-SRC. Sample 6 observed exact historical prewarm set 3 at PRE-PLAY and refused before stimulus/phone launch; no normalization occurred. BATCH-02 is PARTIAL/STOP/SPENT and cannot be topped up. Fresh CLEAR-02 / PRELIGHT-03 / BATCH-03 preserve the guarded source law and must produce a new full N=10 before KERNEL-00 acceptance can be considered. Voice gate 95/95.
