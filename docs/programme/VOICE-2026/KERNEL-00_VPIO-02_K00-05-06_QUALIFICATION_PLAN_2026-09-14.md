...
No physiological qualification change. The post-prewarm observer never attached to the phone and performed no Voice act. Current device process evidence later established harness 0; the stale observer was terminated. Direct wrapper `6ba680b7…` preserves all source physiology and criteria, re-proves Mac output custody + harness zero, then requires PRELIGHT-03 CLEAN before the already-pinned BATCH-03. Any renewed prewarm still STOPs under the unchanged PRE-PLAY/JIT guards. Gate 97/97.
