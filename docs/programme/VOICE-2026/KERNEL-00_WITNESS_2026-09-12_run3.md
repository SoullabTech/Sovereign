...
- **Journal files — integrity check for receipt (founder-supplied SHA-256):** 3a VP ON `kernel00-K00-18f515e1-1789225392.jsonl` = `81b2412773f83a1d2fe6721f35669742be8d28f5fb767debc3a9d01217264661` · 3b VP OFF `kernel00-K00-24694629-1789225445.jsonl` = `c93b19d85774a29292c198773b5966c8f47cf7e09441ef10bd4551647a1110d0`. On attachment here: `sha256sum` must match before the file is preserved beside this record.
