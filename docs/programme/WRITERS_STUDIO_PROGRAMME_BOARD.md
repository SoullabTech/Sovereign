...
| 12 | Creative distances — Close · Near · Middle · Far · Outward | **ZERO-CALLERS** | `canvas/WritingSurface.tsx` (3 files, 0 importers), `CanvasShell` (1, 0 importers) | — | WS-02 harvest | — | ⛔ never render as `Step 1 → 2 → 3` |
