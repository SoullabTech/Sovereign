...
CENSUS IN PROGRESS — this file is completed when all thirteen subsystem pages exist.
...
witness exists for almost nothing here (that absence is itself a ranked gap). Not a promotion of
any claim, label, or principle.

## 1 · Founder-question answers, one line per subsystem
_(filled from the pages)_

## 2 · Where current MAIA already embodies v0.2
_(filled from the pages — with paths)_

## 3 · Where current MAIA contradicts v0.2
_(filled from the pages — with paths and the principle / AP)_

## 4 · What is unknown, and the instrument that would answer it
_(filled from the pages)_

## 5 · R11 design audit — cross-subsystem matrix
_(FOUND / NOT FOUND / UNKNOWN per item per subsystem)_

## 6 · Top-10 gaps — proposed ranking
_(impact × leverage ÷ risk, raw scores shown, smallest evidence-producing intervention, experiment fed)_

## 7 · What must MAIA become differently because we know this
_(the Phase 1 answer to the founder's governing question — stated as candidates, not decisions)_

## 8 · Founder stops this map asks for
_(rank · authorize experiments · anything else)_
