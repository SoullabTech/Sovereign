...
- Verbatim with provenance, no synthesis, no cross-session pattern naming: `conversationalRecallBlock.ts:117–129`, `episodicRecallBlock.ts:123–133`; atoms "do NOT cross-reference, synthesize, or interpret across them" `memoryAtomsLoader.ts:455–459`.
...
- Practitioner observations proportioned to epistemic status and framed as invitations, with the verdict/description distinction written into the prompt (`memoryAtomsLoader.ts:503–529,:560–566,:597–606`).
