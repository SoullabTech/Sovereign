# <Subsystem> — whole-organism map page
...
3. Does it preserve Self capacity and World capacity? (separately)
4. What influence does it exert? (P4′ commitments 1–9: met / absent / unknowable from inside)
5. What does it remember?
6. What authority does that information carry? (Authority × Time; verbatim beneath derived?)
7. Does it create useful difference or validation drift? (AP14, AP15)
8. Is it Elementally differentiated or cognitively reductive? (H1 descriptive only)
9. What evidence do we have that a human actually experiences the intended effect? (class C or none)

## 3 · R11 design audit (each: FOUND / NOT FOUND / UNKNOWN, with path)
agreement drift · validation loops · memory-amplified sycophancy · hidden shaping objectives ·
approval optimization · emotional capture · excessive reassurance · historical pattern becoming
identity · "you said before" becoming leverage · MAIA becoming more central rather than returning capacity outward
