...
| Commit SHA of the frozen text | `75570b46b71c4c7c676b7941f4ba34be63106122` — the freezing commit; sealed here per §3.1 |
...
| Commit SHA of the frozen text | `66fc32dacbeeec8b31c8c7c9d2ebe8a88cdf8a8e` — the v1.1 freezing commit; sealed here per §3.1 |
