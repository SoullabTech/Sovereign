...
| Commit SHA of the frozen text | `d2728b4b325a04fe8b74f09d140c760fe49dc8a4` — the freezing commit; sealed here per §3.1 |
...
| Commit SHA of the frozen text | `15106fa70852dc1025d11bc8e2f8982afaf8aba4` — the v1.1 freezing commit; sealed here per §3.1 |
