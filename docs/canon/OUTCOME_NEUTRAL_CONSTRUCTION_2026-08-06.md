...
> ⚠️⚠️ **AMENDMENT TO RATIFIED CANON — 2026-08-09. Lineage, kept inspectable:**
>
> `earlier ratified statement (2026-08-09, §3 + §4 as ratified)`
> → `authorizing act: `[`FOUNDER_RULING_1_COMMITMENT_AUTHORITY_2026-08-09.md`](../design/practitioner-portal/FOUNDER_RULING_1_COMMITMENT_AUTHORITY_2026-08-09.md)` (ratified same day, later act)`
> → `operative amendment: the ruling COUNT only`
>
> ⭐ **Scope, deliberately minimal — one factual count.** Where §3 and §4 say *"the **four open**
> rulings"*, the count is now **three open** (Ruling 1 ratified; Rulings 2–4 open).
>
> ⛔⛔ **Nothing else is amended.** ⭐ The rule is untouched. ⭐ The §4 worked example *"a **UI** that
> presents a commitment container before its jurisdiction is settled → ruling 1"* **stands as a dated
> illustration**: its jurisdiction has since been settled, ⛔ which does not weaken it as a teaching
> case — it is precisely what the rule was authored to prevent, and it was prevented.
>
> ⛔ **The prior wording is preserved below, unedited.** ⛔ Ratified history is ⛔ **not** rewritten to
> read as though it had always said the new thing.
