...
### ⭐⭐⭐ 3.1 The Boundary — what commitment authority does **not** reach

> ⭐⭐⭐ **CANONICAL PLACEMENT.** This is the **single home** of the non-ownership boundary. ⛔ Do not
> restate it in design documents — **reference this section**. Authority:
> [`FOUNDER_RULING_1_COMMITMENT_AUTHORITY_2026-08-09.md`](FOUNDER_RULING_1_COMMITMENT_AUTHORITY_2026-08-09.md)
> §2 (ratified), §3 (**Boundary** term of the decision grammar).
...
> member, their identity, history, data, memories, or activity outside the constituted
> relationship."*

⭐⭐⭐ **Sections 1–4 above answer *what grants authority*. This answers *what authority does not
reach*.** ⛔ Without it the grid is one-sided, and a legitimate grant can silently widen into general
possession.

| ⭐ Relationship authority | ⛔ **is never** | Ownership authority |
|---|---|---|

⭐ **Why it is constitutional, not decorative** (Ruling 1 Amendment 1): *"Defining the commitment
without defining what it does not reach leaves open precisely the **authority creep** this
constitution exists to prevent."*

⛔ **Therefore a constituted commitment does not authorize:** access to the member's identity, history,
data, or memories beyond the acts governed within the relationship · any act outside the constituted
relationship · treating either person as an object of the relationship rather than a party to it.

⭐ **Convergent, independently reached:** Ontology **N8** (⛔ no member-derived state on a Work) and
the [Bring Forward Provenance Review](BRING_FORWARD_PROVENANCE_REVIEW_2026-08-06.md) (*"Authorship —
which person performed the act. **Never ownership** of the source material."*) ⭐ arrived at the same
boundary from the object side and the provenance side. **Consent to relationship ⛔ never becomes
