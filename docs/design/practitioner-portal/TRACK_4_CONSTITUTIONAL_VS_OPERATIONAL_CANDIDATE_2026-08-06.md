...
⭐ Work ratification does ⛔ not merely create governed data — it creates **eligibility**. `member_id`
linkage does ⛔ not merely populate rows — it establishes that later constitutional acts **have
...
|---|---|---|
| link `practitioner_clients.member_id` | ✅ yes — no meaning decided | ⭐ operational **on this gate** · ⚠️ ⛔ **open on the §6 gate** |
...
| seed `relationship_spaces` | 🔴 **no** | ⛔ **crossed** — is Track 2 ruling 1 |
