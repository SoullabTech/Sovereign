...
experience_verification: >-
  IMMERSIVE ARRIVAL + APPEARANCE WITNESS, 2026-09-16: member-chosen Studio atmosphere and Canvas material were carried from `/writers-studio` into the exact rebuilt Work identity, through Chapter/Section view changes and Pure Canvas, without changing window scroll, Work identity, Focus, or manuscript version. The rebuilt manuscript owns its nested scroll boundary; outline navigation moves that boundary rather than the browser page. Develop now uses the existing real Studio mode route and preserves the same manuscript identity. Desktop and mobile appearance reachability were witnessed with Forest + Parchment, including a mobile sheet treatment rather than a clipped desktop popover. Captures: writers-studio-immersive-home-desktop.png, writers-studio-immersive-home-mobile.png, writers-studio-immersive-workspace-desktop.png, writers-studio-immersive-pure-canvas-desktop.png.
