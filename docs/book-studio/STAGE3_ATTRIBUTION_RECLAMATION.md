...
## Group A — Chapter 5 · bare famous-author attributions

**Register:** manuscript-like language under a direct byline that invites
verification.

| | Attribution | Text |
|---|---|---|
| **L756** | — Rumi | "It is the eternal flame of becoming that animates each kaleidoscopic universe sparkling to life like fireflies winking in the infinite night." |
| **L764** | — Clarissa Pinkola Estés | "In the fire's eternal dance, we glimpse ourselves as we truly are—not separate beings but lively sparks whirling in the flames of an infinite spiritual bonfire." |
...
**Register:** developmental prose under an `Adapted from…` label that *appears* to
have already done the provenance work.

| | Attribution | Text |
|---|---|---|
| **L359** | Adapted from Lao Tzu | "Ancient wisdom echoes through the ages, whispering the truths of our interconnectedness with nature and the cosmos…" |
| **L373** | Adapted from Nassim Haramein | "Like a torus, life is an ongoing balance of expansion and contraction, giving and receiving, integrating and differentiating…" |
| **L389** | Adapted from Black Elk | "The circle is a reminder that each moment, each step of the journey, is both a beginning and an end, a process of becoming whole." |
| **L403** | Adapted from Carl Jung | "The spiral is a symbol of the transformative journey of life, inviting us to continually evolve and expand our understanding." |
| **L479** | Adapted from Lao Tzu | "The path to wisdom and personal transformation is often winding and spiraling, inviting us to revisit and refine our understanding continually." |

**Evidence on record:** **L403 and L479 share one distinctive construction** —
*"inviting us to … our understanding"* — under **two different attributed
...
"soulplay" is), L403 (what the spiral symbolises), L479 (what the path to wisdom
is like). **Attributing a definition to an authority is a distinct move from
attributing an image or an aphorism:** it borrows the authority's standing to fix
a term the book depends on.

**Recorded as an observation.** It may sharpen the adjudication — a defined term
the book relies on is harder to simply delete than a decorative epigraph — but it
does not bear on origin.
