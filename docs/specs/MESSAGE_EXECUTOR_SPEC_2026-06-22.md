...
- **recipient(s)** — fully resolved, as the member will be seen to have addressed them
- **channel** (email / Slack / …)
- **1:1 vs group**
- **internal vs external**
- **persistent / searchable status** — does it live in a searchable archive others can read?
- **attachments**, if any
- **whether the action can be revoked** — for a send, the plain statement that exclusive authorship is **lost** on delivery
...
- **draft** — stored draft id; legible, deletable.
...
- **Doctrine home** — when §15 is lifted, confirm canon vs spec placement and the standalone doc's relationship to `MAIA_CONSENT_GATES.md`.
