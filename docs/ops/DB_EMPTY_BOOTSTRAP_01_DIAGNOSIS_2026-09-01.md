...
Next ruling required:
  DB-EMPTY-BOOTSTRAP-02 — Baseline Architecture + Empty-Replay Contract
  (design only; O1 + O4 as direction, O2 rejected as reconstruction-as-recovery,
  O3 rejected as primary architecture)
```
