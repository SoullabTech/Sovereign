...
- ⭐ **Electron is a host adapter, not a domain boundary.** No canonical capability may depend
  ...
  2026-08-29 and binding on **ALL MAIA Desktop work from here on** — not scoped to a named unit —
  the five placement questions,
  the forbidden list, the SOURCE census of the current tree, and what the invariant deliberately does
  NOT authorize are in `docs/architecture/SOVEREIGN_PORTABILITY_INVARIANT_2026-08-29.md`. Enforced
