...
exports.interpretPlanetInDecan = exports.getDecanByTarot = exports.getDecansByRuler = exports.getDecansByElement = exports.getDecansBySign = exports.getDecanBySignAndDegree = exports.getDecanByDegree = exports.DECANS = void 0;
/**
 ...
 */
function getDecanByDegree(absoluteDegree) {
    const normalizedDegree = absoluteDegree % 360;
    return exports.DECANS.find((decan) => normalizedDegree >= decan.startDegree && normalizedDegree < decan.endDegree);
}
exports.getDecanByDegree = getDecanByDegree;
/**
 * Helper function to get decan by sign and degree within sign
 */
function getDecanBySignAndDegree(sign, degreeInSign) {
    return exports.DECANS.find((decan) => decan.sign === sign &&
        degreeInSign >= decan.startDegreeInSign &&
        degreeInSign < decan.endDegreeInSign);
}
exports.getDecanBySignAndDegree = getDecanBySignAndDegree;
/**
 * Helper function to get all decans for a specific sign
 */
function getDecansBySign(sign) {
    return exports.DECANS.filter((decan) => decan.sign === sign);
}
exports.getDecansBySign = getDecansBySign;
/**
 * Helper function to get all decans for a specific element
 */
function getDecansByElement(element) {
    return exports.DECANS.filter((decan) => decan.element === element);
}
exports.getDecansByElement = getDecansByElement;
/**
 * Helper function to get all decans ruled by a specific planet
 */
function getDecansByRuler(ruler) {
    return exports.DECANS.filter((decan) => decan.ruler === ruler);
}
exports.getDecansByRuler = getDecansByRuler;
/**
 * Helper function to get decan for a specific tarot card
 */
function getDecanByTarot(tarotCard) {
    return exports.DECANS.find((decan) => decan.tarotCard === tarotCard);
}
exports.getDecanByTarot = getDecanByTarot;
/**
 * Helper function to interpret planet in decan
 */
function interpretPlanetInDecan(planet, decan) {
...
exports.interpretPlanetInDecan = interpretPlanetInDecan;
exports.default = exports.DECANS;
//# sourceMappingURL=decanSystem.js.map