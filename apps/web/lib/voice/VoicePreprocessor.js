...
exports.VoicePreprocessor = void 0;
/**
 * Voice Preprocessor
...
class VoicePreprocessor {
     ...
     */
    static processForVoice(text, voiceMode = 'natural') {
        let processed = text;
     ...
     */
    static handlePauses(text, voiceMode) {
        const pausePatterns = [
            /\*pauses?\*?/gi,
     ...
     */
    static handleBreathing(text, voiceMode) {
     ...
     */
    static handleEmotionalDirections(text, voiceMode) {
     ...
     */
    static handlePhysicalActions(text, voiceMode) {
     ...
     */
    static handleNarrativeText(text, voiceMode) {
     ...
     */
    static handleAsterisks(text, voiceMode) {
     ...
     */
    static optimizeForVoiceFlow(text) {
        let optimized = text;
     ...
     */
    static extractSpokenContent(text) {
     ...
     */
    static validateVoiceOutput(text) {
        const issues = [];
     ...
     */
    static previewVoiceOutput(originalText) {
...
exports.VoicePreprocessor = VoicePreprocessor;
//# sourceMappingURL=VoicePreprocessor.js.map