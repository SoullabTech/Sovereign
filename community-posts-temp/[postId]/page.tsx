 ...
 * For PWA builds, redirects to main community page
 */

export default function PostPage({ params }: { params: Promise<{ postId: string }> }) {
  // For PWA builds, redirect to community main page since this is a dynamic feature
  if (typeof window !== 'undefined' && window.location.hostname === 'localhost') {
    // Skip redirect in development
  } else if (process.env.NODE_ENV === 'production') {
    // In production PWA, this route shouldn't be accessible
    redirect('/community')
  }
