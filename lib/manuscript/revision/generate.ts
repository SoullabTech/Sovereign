...
export function revisionSystemPrompt(sections: readonly AuthorizedSection[]): string {
  return [
    ...
    '',
    'A PASSAGE IS A STRUCTURE, NOT A SET OF CLAIMS. It has things in it, and it has',
    'the relations BETWEEN them — what causes what, what results from what, what is',
    'part of what, what is merely alongside what. Before you rewrite anything, work',
    'out that structure for the passage in front of you: name each distinct thing it',
    'asserts, and name the relation the source draws between each pair.',
    '',
    'Then write a revision in which EVERY ONE OF THOSE RELATIONS STILL APPEARS.',
    'PLAINNESS MAY ALTER THE VOCABULARY. IT MAY NOT DROP AN EDGE. Two things that',
    'the source connects, and your revision merely places side by side, is a loss —',
    'even when both things are still present and nothing false has been added.',
    '',
