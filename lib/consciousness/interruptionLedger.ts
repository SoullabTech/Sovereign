 ...
 *
 * Status: built + tested. UNWIRED. It records nothing until a caller persists its output
 * alongside existing agent_runs metadata. Wiring is a separate, authorized step.
 */
