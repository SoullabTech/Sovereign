...
const LEVEL_LLM_CONFIG: Record<ConsciousnessLevel, LLMConfig> = {
  1: LOCAL_TIER_ENABLED
    ...
    : { provider: 'anthropic', model: 'claude-sonnet-4-5-20250929', temperature: 0.7, maxTokens: 500 },
  2: LOCAL_TIER_ENABLED
    ? { provider: 'ollama', model: OLLAMA_MODEL_GENERAL, temperature: 0.8, maxTokens: 500 }
    : { provider: 'anthropic', model: 'claude-sonnet-4-5-20250929', temperature: 0.75, maxTokens: 600 },
  3: {
    provider: 'anthropic',
