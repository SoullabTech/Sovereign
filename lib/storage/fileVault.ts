...
// same filesystem root; Co-Lab image attachments reuse this helper so chat does NOT
// become a separate file system — bytes co-locate under FILE_STORAGE_PATH, with each
// caller owning its own metadata registry (studio: practitioner_files; chat: the
// message row's `attachments` JSONB).
//
 ...
 * RELATIVE to the vault root (e.g. "team-chat/<uuid>.png") for later retrieval.
 */
