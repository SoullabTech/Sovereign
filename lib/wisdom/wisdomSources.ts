...
export const WISDOM_SOURCES: WisdomDomain[] = [
  ...
  {
    id: 'sacred-texts',
    title: 'Sacred Texts & Contemplative Traditions',
    icon: 'BookOpen',
    color: 'amber',
    description: 'Passages from sacred texts offered for personal reflection, honoring their original context and tradition',
    sources: [
      { title: 'The Qur\'an', author: 'Trans. M.A.S. Abdel Haleem', focus: 'Sacred text of Islam — selected passages for contemplation' },
      { title: 'The Bible', author: 'Various translations', focus: 'Hebrew Bible and New Testament — wisdom, psalms, and contemplative passages' },
      { title: 'The Bhagavad Gita', author: 'Trans. Eknath Easwaran', focus: 'Hindu scripture on duty, devotion, and the nature of self' },
      { title: 'The Torah', author: 'Hebrew Scripture', focus: 'Five Books of Moses — covenant, law, and sacred narrative' },
      { title: 'The Dhammapada', author: 'Trans. Eknath Easwaran', focus: 'Core Buddhist teachings on mind, conduct, and liberation' },
      { title: 'The Tibetan Book of the Dead', author: 'Trans. Robert Thurman', focus: 'Bardo Thodol — guidance through transitions and states of consciousness' },
      { title: 'The Tibetan Book of Living and Dying', author: 'Sogyal Rinpoche', focus: 'Tibetan Buddhist wisdom on impermanence, compassion, and presence' },
      { title: 'The Tao Te Ching', author: 'Trans. Stephen Mitchell', focus: 'Foundational Taoist text on the way, virtue, and effortless action' },
      { title: 'The Upanishads', author: 'Trans. Eknath Easwaran', focus: 'Vedantic philosophy on the nature of reality, self, and the absolute' },
      ...
      { title: 'Pistis Sophia', author: 'Trans. G.R.S. Mead', focus: 'Gnostic text on Sophia, divine feminine wisdom, and the soul\'s journey through light' },
    ],
  },
  {
    id: 'mayan',
