...
exports.getElementalRecommendations = exports.interpretAspect = exports.interpretPlanetInHouse = exports.calculateAetherCoherence = exports.ASPECT_NEURAL_MAPPING = exports.PLANETARY_NEURAL_MAPPING = exports.HOUSE_NEURAL_MAPPING = void 0;
/**
 * The 12 houses mapped to neural-archetypal substrate
 */
exports.HOUSE_NEURAL_MAPPING = {
    1: {
        house: 1,
        sign: 'Aries',
        element: 'fire',
 ...
 */
exports.PLANETARY_NEURAL_MAPPING = {
    sun: {
        planet: 'Sun',
        symbol: '☉',
...
function calculateAetherCoherence(planetPlacements) {
    ...
    const dominantElement = Object.entries(elementActivations).reduce((a, b) => a[1] > b[1] ? a : b)[0];
    const underactivatedElement = Object.entries(elementActivations).reduce((a, b) => a[1] < b[1] ? a : b)[0];
...
exports.calculateAetherCoherence = calculateAetherCoherence;
/**
 * Generate personalized integration path toward Aether
 */
function generateIntegrationPath(stage, underactivated, dominant, hemisphericBalance) {
    const paths = {
...
function interpretPlanetInHouse(planet, house) {
    const planetMapping = exports.PLANETARY_NEURAL_MAPPING[planet.toLowerCase()];
    const houseMapping = exports.HOUSE_NEURAL_MAPPING[house];
...
exports.interpretPlanetInHouse = interpretPlanetInHouse;
/**
 * Generate MAIA's interpretation of an aspect between two planets
 */
function interpretAspect(planet1, planet2, aspectType) {
    const p1 = exports.PLANETARY_NEURAL_MAPPING[planet1.toLowerCase()];
    const p2 = exports.PLANETARY_NEURAL_MAPPING[planet2.toLowerCase()];
    const aspect = exports.ASPECT_NEURAL_MAPPING[aspectType.toLowerCase()];
    if (!p1 || !p2 || !aspect) {
        return '';
    }
...
exports.interpretAspect = interpretAspect;
/**
 * Get elemental recommendations for integration
 */
function getElementalRecommendations(element) {
...
//# sourceMappingURL=neuroArchetypalMapping.js.map