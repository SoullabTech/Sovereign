...
export const CANDIDATES = Object.freeze([
  ...
  { id: 'DC-P17', kills: 'R-S2', belief: 'first-add wall-clock order may stand in for git ancestry',
    decisions: { succeedByFirstAdd: (/** @type {any[]} */ set) => {
      const syntheticWallClock = new Map([
        ['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 300],
        ['bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb', 100],
        ['cccccccccccccccccccccccccccccccccccccccc', 200],
      ]);
      const sorted = [...set].sort((a, b) => (syntheticWallClock.get(b.first_add_commit) || 0) - (syntheticWallClock.get(a.first_add_commit) || 0));
